" gbin color scheme adapted from tir_black
...
let colors_name = "gbin"

" General colors
" hi Normal guifg=#f6f3e8 guibg=black ctermfg=white ctermbg=0
hi Normal guifg=#f6f3e8 guibg=black ctermfg=182 ctermbg=0
...
hi Error ctermfg=203 ctermbg=none guisp=#FF6C60
...
" Syntax highlighting
" gbin : I touched Comment that were too grey
hi Comment guifg=#7C0000 ctermfg=3
hi String guifg=#A8FF60 ctermfg=155
hi Number guifg=#FF73FD ctermfg=207

hi Keyword guifg=#96CBFE ctermfg=117
" hi PreProc guifg=#86BBEE ctermfg=175
hi PreProc ctermfg=182 ctermbg=233
...
hi Operator guifg=white ctermfg=100
